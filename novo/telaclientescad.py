...
# importa arquivos app/logica_clientes.py e app/logica_pedidos.py
from app import logica_clientes
from app import logica_pedidos
...
class JanelaClientes:
    ...
    def __init__(self, root):
        ...
        self.lista_clientes = logica_clientes.carregar_clientes()
    ...
    def criar_formulario_cliente(self):
        ...
        # cria o botão salvar
        self.btn_salvar = tk.Button(self.area_formulario,text="Salvar", command=self.salvar_cliente, bg="#000000",fg="#ffffff",font=("Arial", 12, "bold"),bd=0,activebackground="#222222",activeforeground="#ffffff",cursor="hand2")
    ...
    def mostrar_endereco(self):
        ...
        self.criar_campo_endereco("Nome", 0.00, 0.00, 0.86, "ent_endereco_nome")
        self.criar_campo_endereco("CEP", 0.00, 0.18, 0.38, "ent_endereco_cep")
        self.criar_campo_endereco("Número", 0.50, 0.18, 0.36, "ent_endereco_numero")
        self.criar_campo_endereco("Logradouro", 0.00, 0.36, 0.86, "ent_endereco_logradouro")
        self.criar_campo_endereco("Complemento/Referência", 0.00, 0.54, 0.86, "ent_endereco_complemento")
        self.criar_campo_endereco("Bairro", 0.00, 0.72, 0.38, "ent_endereco_bairro")
        self.criar_campo_endereco("Cidade", 0.52, 0.72, 0.34, "ent_endereco_cidade")
    ...
    def obter_valor_entry(self, nome_atributo):
        entry = getattr(self, nome_atributo, None)
    ...
    def montar_endereco(self):
        endereco = {
            "nome": self.obter_valor_entry("ent_endereco_nome"),
            "cep": self.obter_valor_entry("ent_endereco_cep"),
            "numero": self.obter_valor_entry("ent_endereco_numero"),
            "logradouro": self.obter_valor_entry("ent_endereco_logradouro"),
            "complemento": self.obter_valor_entry("ent_endereco_complemento"),
            "bairro": self.obter_valor_entry("ent_endereco_bairro"),
            "cidade": self.obter_valor_entry("ent_endereco_cidade")
        }
    ...
    def salvar_cliente(self):
        ...
        logica_clientes.novo_cliente(self.lista_clientes, nome, cpf, telefone, email, endereco)
        logica_clientes.salvar_clientes(self.lista_clientes)
